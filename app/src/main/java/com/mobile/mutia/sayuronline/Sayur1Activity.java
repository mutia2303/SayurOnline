...
public class Sayur1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sayur1);
    ...
    private void dataSayur1() {

        ConfigRetrofit.getInstance().getApi().getSayur1().enqueue(new Callback<ResponseSayur>() {
            @Override
            public void onResponse(Call<ResponseSayur> call, Response<ResponseSayur> response) {
                if (response.isSuccessful()) {
                    ...
                    if (data == 1) {
                        ...
                        recyclerView.setLayoutManager(new LinearLayoutManager(Sayur1Activity.this));
                        AdapterSayur adapter = new AdapterSayur(Sayur1Activity.this, sayur);
                        recyclerView.setAdapter(adapter);

                        GridLayoutManager gridLayoutManager = new GridLayoutManager(Sayur1Activity.this, 2);
                        ...
                        Toast.makeText(Sayur1Activity.this, pesan, Toast.LENGTH_SHORT).show();
                    }
                }
            }
