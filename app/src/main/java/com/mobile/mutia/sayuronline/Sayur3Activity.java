...
public class Sayur3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sayur3);
    ...
    private void dataSayur3() {

        ConfigRetrofit.getInstance().getApi().getSayur3().enqueue(new Callback<ResponseSayur>() {
            @Override
            public void onResponse(Call<ResponseSayur> call, Response<ResponseSayur> response) {
                if (response.isSuccessful()) {
                    ...
                    if (data == 1) {
                        ...
                        recyclerView.setLayoutManager(new LinearLayoutManager(Sayur3Activity.this));
                        AdapterSayur adapter = new AdapterSayur(Sayur3Activity.this, sayur);
                        recyclerView.setAdapter(adapter);

                        GridLayoutManager gridLayoutManager = new GridLayoutManager(Sayur3Activity.this, 2);
                        ...
                        Toast.makeText(Sayur3Activity.this, pesan, Toast.LENGTH_SHORT).show();
                    }
                }
            }
