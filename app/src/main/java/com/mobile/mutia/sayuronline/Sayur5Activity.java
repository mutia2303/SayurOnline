...
public class Sayur5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sayur5);
    ...
    private void dataSayur5() {

        ConfigRetrofit.getInstance().getApi().getSayur5().enqueue(new Callback<ResponseSayur>() {
            @Override
            public void onResponse(Call<ResponseSayur> call, Response<ResponseSayur> response) {
                if (response.isSuccessful()) {
                    ...
                    if (data == 1) {
                        ...
                        recyclerView.setLayoutManager(new LinearLayoutManager(Sayur5Activity.this));
                        AdapterSayur adapter = new AdapterSayur(Sayur5Activity.this, sayur);
                        recyclerView.setAdapter(adapter);

                        GridLayoutManager gridLayoutManager = new GridLayoutManager(Sayur5Activity.this, 2);
                        ...
                        Toast.makeText(Sayur5Activity.this, pesan, Toast.LENGTH_SHORT).show();
                    }
                }
            }
